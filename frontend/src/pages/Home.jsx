...
const Home = () => {
  ...
  return (
    <>
      <MainLayout>
        {!isLoggedIn ? (
          <div className='bg-primary text-yellow h-[40vh] py-8 text-center'>
            <h1 className='text-2xl'> Welcome to my  Task Manager App</h1>
          ...
          <>
            <h1 className='text-lg mt-8 mx-8 border-b border-bg bg-yellow-300'>Welcome {authState.user.name}</h1>
            <Tasks />
          </>
        )}
      </MainLayout>
